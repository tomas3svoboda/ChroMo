...
class Operator:
    ...
    def Start(self):
        ...
        path = "C:\\Users\\Adam\\Documents\\test_fileread"
    ...
    def Load_experiment_set(self, path):
        filenames = next(walk("C:\\Users\\Adam\\Documents\\test_fileread"), (None, None, []))[2]
        for file in filenames:
            ...
            feed_volume = df.iat[2, 1]
            columnNames = df.iloc[[6]].to_numpy()[0]
            feed_concentrations = df.iloc[[5]].to_numpy()[0][1:]
