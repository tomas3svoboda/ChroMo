...
from simSMB_linear import simSMB_linear
...
def objectiveSMB_linear(
    ...
    """
    Run linear EDM SMB, take the *last full switch period*, interpolate to experimental points,
    and compute MSE over {Extract A/B, Raffinate A/B}.
    """
    # 1) simulate once
    df_ext, df_raf = simSMB_linear(
        end_time=end_time,
