...
from ChroMo_PE.functions.Dead_Volume_Adjustment import Dead_Volume_Adjustment
...
def Model_Analysis(experimentComp, solver, params, spacialDiff = 30, timeDiff = 3000, time = 10800, webMode = False, title = False, full = False):
    ...
    if full:
        ...
        if solver == "Nonlin":
            ...
            ax4.plot(t, model[3])  # Plot the residuals over time
