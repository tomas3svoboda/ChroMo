...
'''
This script implements Cranck-Nicolson semi-implicit method for numerical solution of
...
def Lin_Solver(flowRate = 150,       # Volume flowrate in [mL/h]
               ...
               feedConc=9.09,     # Concentration of the balanced component in the feed [g/mL] or [mg/mm^3]
               porosity=0.375,        # Total porosity of the adsorbent packing [-]
               henryConst=3.1,      # Henry's constant of the linear isotherm [-]
               disperCoef=17.62185,       # Axial dispersion coefficient [mm^2/s]
    ...
    if debugPrint:
        ...
        print('Henry Constant:   ' + str(round(henryConst, 2)))
...
#=========================================================================================================================
#=========================================================================================================================
res = Lin_Solver(debugPrint=True,
            debugGraph=True,
            full=True)
...
# Save to Excel
output_file = "linsolver_numeric_comparison_correction_disp13.xlsx"
