...
from ChroMo_PE.objects.ExperimentClusters import ExperimentClusters
from ChroMo_PE.functions.Fit_Gauss import Fit_Gauss
from ChroMo_PE.functions.Ret_Time_Cor import Ret_Time_Cor
from ChroMo_PE.functions.Mass_Balance_Cor import Mass_Balance_Cor
...
from ChroMo_PE.functions.Bilevel_Optim import Bilevel_Optim
from ChroMo_PE.functions.solvers.Solver_Choice import Solver_Choice
from ChroMo_PE.functions.Handle_File_Creation import Handle_File_Creation
from ChroMo_PE.functions.Dead_Volume_Preprocess import Dead_Volume_Preprocess
from ChroMo_PE.functions.singleLossFunctions.Multi_Loss_Function_Wrapper import Multi_Loss_Function_Wrapper
from ChroMo_PE.functions.handle_Optim_Settings import handle_Optim_Settings
...
class Operator:
    ...
    def Start_For_Testing(self):
        ...
        # !!!!!!!!!!!!! Tady vyplň !!!!!!!!!!!!!!!
        path = "C:\\Users\\Adam\\ChroMo_PE\\data\\LossFunctionExperimentSet"
        experimentSet = self.Load_Experiment_Set(path)
        ...
        # C:\Users\Adam\ChroMo_PE\data\LossFunctionSingleExperiment
        # C:\Users\Adam\ChroMo_PE\data\LossFunctionExperimentSet
        ...
        solution.Export_To_CSV("C:\\Users\\Adam\\ChroMo_PE\\testSolution.csv")'''
